...
{"type":"toggle","text":"Auto Set Koordinat (Punch to Save)","alias":"AutoSetRemote","default":false},
    ...
    {"type":"toggle_button","text":"Only Planting","alias":"PlantToggle","default":true},
    {"type":"toggle_button","text":"Only Harvesting","alias":"HarvestToggle","default":true},
...
local json = [[
{
  ...
  "menu": [
    ...
    {"type":"item_picker","text":"Place Block","item":"Dirt","default":"Blank","alias":"PNB_ID"},
    {"type":"input_int","text":"Delay(ms)","default":"120","icon":"Timer","alias":"PNB_Delay"},
    {"type":"slider","text":"Range Far","min":1,"max":10,"default":5,"step":1,"alias":"PNB_Far"},
...
local json = [[
{
  ...
  "menu": [
     {"type":"item_picker","text":"Drop Item","item":"Dirt","default":"Blank","alias":"MagDrop"},
{"type":"input_string","text":"Koordinat Magplant (X,Y)","default":"9,116","icon":"LocationOn","alias":"MagKoor"},
{"type":"input_int","text":"Delay (ms)","default":"250","icon":"Timer","alias":"DelayMAG"},
      {"type":"toggle","text":"Auto Set Koordinat","alias":"CekKoor","default":false},
    {"type":"toggle_button","text":"Start Retrieve Mag & Drop","alias":"MAGToggle","default":false}
]
}
]]
addIntoModule(json)
...
local json = [[
{
  ...
  "menu": [
    {"type":"toggle","text":"Auto Leave Mods Login","alias":"AutoLeaveEnabled","default":false},
{"type":"toggle","text":"Check Koordinat","alias":"CekKoordinat","default":false}, {"type":"toggle","text":"ModFly","alias":"ModFly","default":false},
